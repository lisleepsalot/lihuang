        ...
        const projects = [
            { name: "RISD yearbook 2025", year: "2025" },
            { name: "Hope & Anchor", year: "2025" },
            { name: "RISD Commencement", year: "2025" },
            { name: "Six Memos for the Next Millennium", year: "2025" },
            { name: "Struve Geodetic Arc", year: "2025" },
            { name: "Instructional Typography", year: "2025" },
            { name: "Debates in AI", year: "2025" },
            { name: "RISD Museum", year: "2025" },
            { name: "RISD Yearbook 2024", year: "2025" },
            { name: "Heap", year: "2025" },
            { name: "Clean Wipes 11", year: "2025" },
            { name: "Mr.Jones", year: "2025" },
            { name: "Cloupd Hopper", year: "2025" },
            { name: "Anatomy of Fascism", year: "2025" },
            { name: "To Cook with an Open Kitchen", year: "2025" },
            { name: "Whatever", year: "2025" },
            { name: "Atlas Swing", year: "2025" },
            { name: "Here for now", year: "2025" },
            { name: "Kukai Symphony", year: "2025" },
            { name: "Trestle", year: "2025" }
        ];
        ...
        projects.forEach((project, index) => {
            ...
            if (project.isBorder) {
                ...
                gridCell.innerHTML = `
                    <div class="display-grid-container">
                        <div class="display-grid-image" style="background-image: url('./placeholder.jpeg');"></div>
